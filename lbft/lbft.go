...
func NewLbft(
	...
	committedBlocks chan *blockchain.Block,
	forkedBlocks chan *blockchain.Block,
	cleanBlocks chan *blockchain.Block) *Lbft {
	lb := new(Lbft)
	lb.Node = node
	lb.Election = elec
	lb.pm = pm
...
func (lb *Lbft) MakeProposal(view types.View, payload []*message.Payload) *blockchain.Block {
